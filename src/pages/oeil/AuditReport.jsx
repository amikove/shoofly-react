...
export default function AuditReport() {
  ...
  return (
    <AppLayout>
      ...
      {/* Barre d'actions */}
      {!submitted && (
        <div className="fixed bottom-20 md:bottom-0 left-0 right-0 md:left-[220px] bg-[#181818] border-t border-white/12 p-4 flex gap-3 z-40">          <button onClick={save} disabled={saving} className="btn btn-ghost flex-1 justify-center disabled:opacity-50">
