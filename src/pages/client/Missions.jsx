  ...
  return (
    <AppLayout>
      ...
      <div className="p-6">
        ...
        {loading ? (
          ...
          <EmptyState
            ...
            description="Créez votre première mission."
            action={
                    ...
                    <tr key={m.id}>
                      ...
                      <td>
                        <div className="flex gap-1 flex-wrap">
                          {/* Chat — disponible si mission en cours */}
                          ...
                          {/* Voir rapport — mission complétée */}
                          {m.status === 'completed' && (
                            <button
                              onClick={() => setReportMission(m)}
                              className="btn btn-ghost btn-sm"
                            >
                              📄
                            </button>
                          )}
                          {/* Noter — mission complétée */}
                          {m.status === 'completed' && (
                            <button
      ...
      <NewMissionModal
        ...
        onCreated={(m) => { load(); toast('Mission créée ! 🎉', 'success') }}
      />
...
// Visionneuse rapport pour le client
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="bg-[#222] rounded-xl p-4 text-sm text-[#AAA] leading-relaxed">
                {report.summary}
              </div>
            </div>
            ...
            <div className="text-xs text-[#555] text-right">
              Soumis le {new Date(report.created_at).toLocaleDateString('fr-MA')}
            </div>
          </div>
        )}
      </div>
