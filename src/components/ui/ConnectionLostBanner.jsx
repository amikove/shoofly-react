...
export default function ConnectionLostBanner() {
  ...
  return (
    // Positionnement (fixed / top / z-index) et empilement sous les 3 bannières Œil gérés par le
    // conteneur commun dans AppLayout ; cette bannière ne fait plus que se centrer dans la largeur.
