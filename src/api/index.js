...
export const missionsAPI = {
  ...
  assistance:        (id, data) => api.post(`/api/missions/${id}/assistance`, data),
  assistanceRespond: (id, data) => api.post(`/api/missions/${id}/assistance/respond`, data),
...
export const adminAPI = {
  ...
  walletReconciliationAlerts: (params) => api.get('/api/users/admin/wallet-reconciliation-alerts', { params }),
...
resolveClaim:    (id, decision, dispute_reason) => api.put(`/api/users/admin/claims/${id}/resolve`, { decision, dispute_reason }),
claimsCommissionPending: () => api.get('/api/users/admin/claims/commission-pending'),
claimsCommissionDecide:  (missionId, decision) => api.post(`/api/users/admin/claims/${missionId}/commission`, { decision }),
clientStrikes:       (status) => api.get('/api/users/admin/clients/strikes', { params: { status } }),
clientStrikeHistory: (id)     => api.get(`/api/users/admin/clients/${id}/strikes`),
unblockClient:       (id)     => api.post(`/api/users/admin/clients/${id}/unblock`),
identityRequests:(status)       => api.get('/api/users/admin/identity-requests', { params: { status } }),
